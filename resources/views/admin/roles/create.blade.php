    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Add Role
					<a class="float-sm-right" href="{{ apa('roles') }}"><button class="btn btn-outline-dark btn-flat">Back</button></a></h2>
            </div>
        </div>
    </div>  
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="col-sm-12 card-header form-header">
                 ...
                 {!! Form::open(['method' => 'POST', 'url' => URL::to(Config::get('app.admin_prefix').'/roles/create' ), 'id'=>'post-form'] ) !!}
                        ...
                        <div class="col-sm-12">
                            <div class="button-control-wrapper">
                                <div class="form-group">
                                    ...
                                    <a href="{{ apa('roles') }}" class="btn btn-outline-danger">Close</a>
                                </div>
                            </div>
                        </div>
                    </div>
