...
var CKconfig = {
		...
		filebrowserBrowseUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_browser_ckeditor") }}?type=file',
		filebrowserUploadUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_upload_ckeditor") }}?type=file',
		filebrowserImageBrowseUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_browser_ckeditor") }}?type=image',
		filebrowserImageUploadUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_upload_ckeditor") }}?type=image',
		/**/
	...
	function createEditor(lang, elemID){
        CKEDITOR.disableAutoInline = true;
        if(lang=='ar'){
            CKconfig.contentsLangDirection = 'rtl';
        }
        CKEDITOR.replace( elemID, CKconfig);
    }
