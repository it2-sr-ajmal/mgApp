var CKconfig = {
		...
		filebrowserBrowseUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_browser_ckeditor") }}?type=file&_token={{csrf_token()}}',
		filebrowserUploadUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_upload_ckeditor") }}?type=file&_token={{csrf_token()}}',
		filebrowserImageBrowseUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_browser_ckeditor") }}?type=image&_token={{csrf_token()}}',
		filebrowserImageUploadUrl: '{{ URL::to(Config::get("app.admin_prefix")."/file_upload_ckeditor") }}?type=image&_token={{csrf_token()}}',
		/**/
